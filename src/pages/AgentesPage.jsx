  ...
  return (
    <section className="relative overflow-hidden py-20 md:py-32" style={{ background: 'linear-gradient(135deg, #ff6b6b 0%, #ae2f34 100%)' }}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8 relative z-10">
        <div ref={ref} className={`grid md:grid-cols-12 gap-12 items-center reveal ${isVisible ? 'visible' : ''}`}>
          ...
          <div className="hidden md:block md:col-span-5 relative">
            ...
            <img
              src="https://lh3.googleusercontent.com/aida-public/AB6AXuB5Fqi4AxQvPjZfzcZ9875741PESoDYExVkYe-vD2wBVUazfWEuRV9RzZKUu7dMIvYoTp9xgTidLrtsfuwZAItThqAD_Ht7PfgmAbQgXns0-ywBUZiZbPSUm7iwiL2sqbFELNSJozSxgd7Hc0xfaqnQki2gpsfOGF6Ypg4LaUGJKBAiI83_Esjc8FO5AnpajfLsKynEshgRURcAUBeQDo3M86-uwj4UJqtv2BOyiKyB-ZuxAuLttCHkR1MlMCzBARIhfpfy0QXU_B_H"
              alt="Agente TeVra"
