...
export default function HeroSection() {
  return (
    <section className="relative hero-gradient flex items-center overflow-hidden" style={{ minHeight: '100svh', paddingTop: 'clamp(4rem, 10vh, 6rem)' }}>
      ...
      <div className="w-full h-full max-w-7xl mx-auto px-4 sm:px-8 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center relative z-10 py-8 lg:py-0" style={{ minHeight: 'inherit' }}>
        <div className="space-y-5 sm:space-y-8 py-6 lg:py-12 animate-[slide-left_1s_cubic-bezier(0.16,1,0.3,1)_0.3s_both]">
          ...
          <div className="flex items-center gap-4 mb-2">
            <img src="/LogoTevra.png" alt="TeVra" className="h-10 sm:h-14 w-auto object-contain drop-shadow-lg" />
          ...
          <div className="flex flex-wrap gap-3 sm:gap-5 pt-2">
            <Link
              to="/catalogo"
              className="bg-secondary text-white rounded-2xl font-headline font-bold shadow-xl shadow-secondary/30 hover:-translate-y-1 hover:shadow-2xl hover:shadow-secondary/40 transition-all duration-300"
        ...
        <div className="relative hidden lg:flex items-center justify-center animate-[slide-right_1s_cubic-bezier(0.16,1,0.3,1)_0.5s_both]">
          ...
          <div className="relative z-10 rounded-[2rem] overflow-hidden shadow-[0_32px_80px_rgba(0,0,0,0.45)] border border-white/10 hover:scale-[1.02] transition-transform duration-700" style={{ maxHeight: '65vh', aspectRatio: '1/1' }}>
            <img
