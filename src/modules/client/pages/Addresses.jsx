    ...
    <div className="space-y-8 platform-enter max-w-6xl mx-auto pb-10">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button onClick={openCreate}
          className="bg-slate-900 hover:bg-slate-800 text-[#EEF4ED] px-6 py-3 rounded-2xl font-bold flex items-center justify-center gap-2 transition-all shadow-[0_4px_20px_rgba(0,0,0,0.1)] hover:shadow-[0_8px_30px_rgba(0,0,0,0.15)] hover:-translate-y-0.5 text-sm">
              ...
              <div className="flex items-start justify-between mb-5">
                <div className="flex flex-col gap-1.5">
                  <span className="w-12 h-12 rounded-2xl flex items-center justify-center bg-slate-50 border border-slate-100 mb-2 group-hover:bg-slate-900 group-hover:border-slate-900 transition-colors">
                    <span className="material-symbols-outlined text-slate-400 group-hover:text-[#EEF4ED] transition-colors">signpost</span>
                  </span>
                  <div className="flex items-center gap-2">
                    ...
                    {addr.isDefault && (
                      <span className="text-[10px] font-bold px-2.5 py-1 bg-slate-900 text-[#EEF4ED] rounded-md tracking-widest uppercase">{t('client.addresses.defaultBadge')}</span>
                    )}
                  </div>
                </div>
                ...
                <div className="flex gap-2">
                  ...
                  <button onClick={() => handleDelete(addr.id)} className="w-8 h-8 rounded-full bg-red-50 border border-red-100 flex items-center justify-center hover:bg-red-500 text-red-500 hover:text-[#EEF4ED] transition-colors" title="Eliminar">
