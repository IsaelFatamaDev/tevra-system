...
export default function WhatsAppButton() {
  ...
  return (
    ...
    >
      ...
      <span className="absolute right-20 bg-[#EEF4ED] text-[#134074] px-4 py-2 rounded-xl text-xs font-bold shadow-xl opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none">
        {t('whatsapp.needHelp')}
      </span>
    </Link>
  )
